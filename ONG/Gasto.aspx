<%@ Page Title="Gastos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Gasto.aspx.cs" Inherits="ONG._Gasto" %>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#GastoTable').jtable({
                    ...
                    actions: {
                        listAction: '/Gasto.aspx/ObtieneListaGasto',
                        createAction: '/Gasto.aspx/Create',
                        updateAction: '/Gasto.aspx/Edit',
                        deleteAction: '/Gasto.aspx/Delete'
                    },
                    fields: {
                        UUID: {
                            key: true,
                        ...
                        UUID_CTACONTABLE: {
                            ...
                            width: '15%',
                            options: '/Gasto.aspx/ObtieneOpcionesCC'
                        },
                        UUID_TIPO: {
                            title: 'Tipo',
                            width: '15%',
                            options: '/Gasto.aspx/ObtieneOpcionesTipo'
                        },
                        NIVEL: {
                            title: 'Nivel',
                            width: '15%',
                            options: '/Gasto.aspx/ObtieneOpcionesNivel'
                        },
                        COMENTARIOS: {
                            title: 'Comentarios',
                            type: 'textarea',
