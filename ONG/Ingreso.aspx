<%@ Page Title="Ingresos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ingreso.aspx.cs" Inherits="ONG._Ingreso" %>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#IngresoTable').jtable({
                    ...
                    actions: {
                        listAction: '/Ingreso.aspx/ObtieneListaIngreso',
                        createAction: '/Ingreso.aspx/Create',
                        updateAction: '/Ingreso.aspx/Edit',
                        deleteAction: '/Ingreso.aspx/Delete'
                    },
                    fields: {
                        UUID: {
                            key: true,
                        ...
                        UUID_CTACONTABLE: {
                            ...
                            width: '15%',
                            options: '/Ingreso.aspx/ObtieneOpcionesCC'
                        },
                        UUID_TIPO: {
                            title: 'Tipo',
                            width: '15%',
                            options: '/Ingreso.aspx/ObtieneOpcionesTipo'
                        },
                        NIVEL: {
                            title: 'Nivel',
                            width: '15%',
                            options: '/Ingreso.aspx/ObtieneOpcionesNivel'
                        },
                        COMENTARIOS: {
                            title: 'Comentarios',
                            type: 'textarea',
