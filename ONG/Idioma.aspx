<%@ Page Title="Idiomas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Idioma.aspx.cs" Inherits="ONG._Idioma" %>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#IdiomaTable').jtable({
                    ...
                    actions: {
                        listAction: '/Idioma.aspx/ObtieneListaIdioma',
                        createAction: '/Idioma.aspx/Create',
                        updateAction: '/Idioma.aspx/Edit',
                        deleteAction: '/Idioma.aspx/Delete'
                    },
                    fields: {
                        UUID: {
                            key: true,
                    ...
                    formCreated: function (event, data) {
                        ...
                        data.form.find('input[name="ABREVIATURA"]').addClass('validate[required]');
