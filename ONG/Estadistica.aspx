<%@ Page Title="Estadistica" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Estadistica.aspx.cs" Inherits="ONG._Estadistica" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <div class="site-container">
            ...
            <div id="EstadisticaTable"></div>
        </div>
        <script type="text/javascript">
            $(document).ready(function () {
                $('#EstadisticaTable').jtable({
                    title: 'Lista Estadisticas',
                    paging: true,
                    pageSize: 10,
                    sorting: true,
                    defaultSorting: 'IDENTIFICADOR ASC',
                    actions: {
                        listAction: '/Estadistica.aspx/ObtieneListaEstadistica',
                        createAction: '/Estadistica.aspx/Create',
                        updateAction: '/Estadistica.aspx/Edit',
                        deleteAction: '/Estadistica.aspx/Delete'
                    },
                    fields: {
                        UUID: {
                            key: true,
                        ...
                        UUID_TIPO: {
                            ...
                            width: '15%',
                            options: '/Estadistica.aspx/ObtieneOpcionesTipo'
                        },
                        COMENTARIOS: {
                            title: 'Comentarios',
                            type: 'textarea',
                    ...
                    formCreated: function (event, data) {
                        ...
                        //data.form.find('input[name="TIPO"]').addClass('validate[required]');
                ...
                //$('#EstadisticaTable').jtable('reload');
                //Re-load records when user click 'load records' button.
                $('#SearchButton').click(function (e) {
                    e.preventDefault();
                    $('#EstadisticaTable').jtable('load', {
                        search: $('#search').val()
                    });
                });
