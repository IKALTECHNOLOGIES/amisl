...
namespace ONG
{
    public partial class _Ingreso : Page
    {
        ...
        public static object ObtieneListaIngreso(string search, int jtStartIndex = 0, int jtPageSize = 0, string jtSorting = null)
        {
            ...
            try
            {
                ...
                var lista = from g in context.ingreso
        ...
        [WebMethod(EnableSession = true)]
        public static object Create(Ingreso record)
        {
            amislEntities  context = new amislEntities ();
            try
            {
        ...
        [WebMethod(EnableSession = true)]
        public static object Edit(Ingreso record)
        {
            amislEntities  context = new amislEntities ();
            try
            {
                ingreso n = context.ingreso.First(i => i.UUID == record.uuid);
                {
        ...
        public static object Delete(String UUID)
        {
            ...
            try
            {
                ingreso n = context.ingreso.First(i => i.UUID == UUID);
                context.ingreso.Remove(n);
                context.SaveChanges();
