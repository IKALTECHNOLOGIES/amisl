<%@ Page Title="Cuentas Contables" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CuentaContable.aspx.cs" Inherits="ONG._CuentaContable" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <body>
        <div class="site-container">
            ...
            <div id="CuentaContableTable"></div>
        </div>
        <script type="text/javascript">
            $(document).ready(function () {
                $('#CuentaContableTable').jtable({
                    title: 'Lista Cuentas Contables',
                    paging: true,
                    pageSize: 10,
                    sorting: true,
                    defaultSorting: 'CODIGO ASC',
                    actions: {
                        listAction: '/CuentaContable.aspx/ObtieneListaCC',
                        createAction: '/CuentaContable.aspx/Create',
                        updateAction: '/CuentaContable.aspx/Edit',
                        deleteAction: '/CuentaContable.aspx/Delete'
                    },
                    fields: {
                        UUID: {
                            key: true,
                        ...
                        TIPO: {
                            title: 'Tipo',
                            width: '25%',
                            options: { 'I': 'Ingreso', 'G': 'Gasto' }
                        },
                        NIVEL: {
                            title: 'Nivel',
                            width: '15%',
                            options: '/CuentaContable.aspx/ObtieneOpcionesNivel'
                        },
                        COMENTARIOS: {
                            title: 'Comentarios',
                            type: 'textarea',
                    ...
                    formCreated: function (event, data) {
                        ...
                        data.form.find('input[name="TIPO"]').addClass('validate[required,maxSize[1],custom[integer]]');
                ...
                $('#SearchButton').click(function (e) {
                    e.preventDefault();
                    $('#CuentaContableTable').jtable('load', {
                        search: $('#search').val()
                    });
                });
